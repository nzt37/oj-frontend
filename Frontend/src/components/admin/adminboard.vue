  ...
  <el-row>
    ...
    <el-form label-position="right">
      ...
      <el-form-item label="Codeforces账号">
        <el-input
          v-model="cf"
          placeholder="请填写Codeforces账号，无则留空"
          style="width: 200px"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="Vjudge账号">
        <el-input
          v-model="vjudge"
          placeholder="请填写Vjudge账号，无则留空"
          style="width: 200px"
        ></el-input>
      </el-form-item>
      <el-form-item label="CDUOJ账号">
        <el-input
          v-model="CDUOJ"
          placeholder="请填写CDUOJ账号，无则留空"
          style="width: 200px"
        ></el-input>
      </el-form-item>
    ...
    getuser() {
      this.$axios
        ...
        .then((response) => {
          ...
          this.vjudge = li[2];
          this.CDUOJ = li[3];
          if (li.length > 4) this.otheraccount = li[4];
